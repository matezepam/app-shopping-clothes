        ...
        <div className="grid gap-12 lg:grid-cols-5">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 text-base">
              <Link to="/" onClick={scrollToTop} className={footerLinkClass}>
                {t("footer.home")}
              </Link>

              <Link to="/category/men" onClick={scrollToTop} className={footerLinkClass}>
                {t("footer.men")}
              </Link>

              <Link to="/category/women" onClick={scrollToTop} className={footerLinkClass}>
                {t("footer.women")}
              </Link>

              <Link to="/category/souvenirs" onClick={scrollToTop} className={footerLinkClass}>
                {t("footer.souvenirs")}
              </Link>

              <Link to="/cart" onClick={scrollToTop} className={footerLinkClass}>
                {t("footer.cart")}
              </Link>
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3 text-base">
              ...
              <Link to="/checkout" onClick={scrollToTop} className={footerLinkClass}>
                {t("footer.finishPurchase")}
              </Link>
            </div>
          </div>
        </div>

        <div className="mt-12 rounded-2xl border border-white/10 bg-white/5 p-5 shadow-xl shadow-black/10">
          <LanguageCurrencyBar />
        </div>
      </div>
      ...
      <div className="border-t border-white/10">
        <div className="container mx-auto flex flex-col items-center gap-4 px-4 py-6 text-sm text-white/50 lg:px-8">
          ...
          <div className="flex flex-wrap justify-center gap-6">
            <Link to="/privacy" onClick={scrollToTop} className="transition-colors hover:text-white">
              {t("footer.privacy")}
            </Link>

            <Link to="/returns" onClick={scrollToTop} className="transition-colors hover:text-white">
              {t("footer.returns")}
            </Link>

            <Link to="/about" onClick={scrollToTop} className="transition-colors hover:text-white">
              {t("footer.about")}
            </Link>
          </div>
